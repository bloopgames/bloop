---
# bloop-7ivl
title: Public Launch Week (Jan 5-10)
status: in-progress
type: milestone
priority: normal
...
- [ ] Do first stream (bloop-m2mk)
- [ ] Fix known bugs:
  - [ ] Tape playback performance (bloop-sgc7)
  - [ ] Input buffer replication (bloop-9jk8)
...
## Marketing
- [ ] Initial GIF of development in README (bloop-6yjl)
- [ ] Initial video in README (bloop-docb)
